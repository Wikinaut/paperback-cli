...
static_assert(sizeof(t_data)==128, sizeof(t_data));

#define PBM_COMPRESSED 0x01            // Paper backup is compressed
#define PBM_ENCRYPTED  0x02            // Paper backup is encrypted

// FILETIME is 64-bit data type - to keep alignment, padding required if 
// time_t is 32-bit signed integer (typically 64-bit)
